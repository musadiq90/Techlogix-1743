CREATE OR REPLACE FUNCTION OFSFTP.FTP_FN_CREATE_RT_TXN (P_Xref      VARCHAR2,
                                                        P_Status    VARCHAR2)
   RETURN BOOLEAN
IS
...
BEGIN
   ...
   p_envelope :=
      ...
      || '</fcub:BRANCH>
                                        ...
                                        <fcub:SOURCE_OPERATION>CreateTransaction</fcub:SOURCE_OPERATION>
                                        <fcub:SOURCE_USERID>'
      || l_user_id
      || '</fcub:SOURCE_USERID>
                                        <fcub:ADDL>
