/* Formatted on 2/7/2022 5:34:07 PM (QP5 v5.215.12089.38647) */
DECLARE
   ...
   FOR LOOP_CTRL1
      IN (SELECT FIC_MIS_DATE,
            ...
            FROM (  SELECT FIC_MIS_DATE,
                           ...
                           N_FACE_VALUE,
                           F_REPRICE_FLAG,
                           V_INSTRUMENT_CODE AS V_INST_PRICE_CODE,
     ...
     /* DBMS_OUTPUT.PUT_LINE (
      ...
      INSERT INTO RPT_HYPOTHETICAL_PL (FIC_MIS_DATE,
         ...
         SELECT L_FIC_MIS_DATE,
                ...
                LN_HYPOTHETICAL_PL
           FROM DUAL; */
   DBMS_OUTPUT.PUT_LINE ( LOOP_CTRL1.V_INSTRUMENT_CODE || '||' || LOOP_CTRL1.V_INSTRUMENT_TYPE || '||' || LOOP_CTRL1.N_PREV_POSITION ||'||' || LN_PREV_PRICE || '||' ||LN_CURR_PRICE );
   END LOOP;
END;